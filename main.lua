...
-- UI WINDOW
-- ============================================================
-- FIX: Removed slashes which were causing directory creation errors
local Window = Library:CreateWindow(
    "NoFear_RightControlToHide", 
    Vector2.new(492, 598),
...
SettingsSection:AddButton("Unload Script", function()
    ...
    pcall(function()
        for _, v in pairs(game:GetService("CoreGui"):GetChildren()) do
            -- Updated check to match new title name
            if v.Name == "NoFear_RightControlToHide" or v.Name:find("NoFear") then
                v:Destroy()
            end
        end
    end)
